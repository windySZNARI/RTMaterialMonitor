...
public:
    ...
    void setupUi(QDialog *RTMaterialMonitorClass)
    {
        ...
        groupBox = new QGroupBox(RTMaterialMonitorClass);
        ...
        lblLargeStove = new QLabel(RTMaterialMonitorClass);
        lblLargeStove->setObjectName(QStringLiteral("lblLargeStove"));
        lblLargeStove->setMinimumSize(QSize(100, 100));

        verticalLayout->addWidget(lblLargeStove);

        label_31 = new QLabel(RTMaterialMonitorClass);
        ...
        groupBox_2 = new QGroupBox(RTMaterialMonitorClass);
        ...
        gridLayout_4->addWidget(lineEdit_9, 5, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lineEdit_8, 4, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lineEdit_12, 2, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lineEdit_13, 3, 1, 1, 1);
        ...
        label_32 = new QLabel(RTMaterialMonitorClass);
        label_32->setObjectName(QStringLiteral("label_32"));
        label_32->setMinimumSize(QSize(100, 100));

        verticalLayout_4->addWidget(label_32);

        label_33 = new QLabel(RTMaterialMonitorClass);
        ...
        label_34 = new QLabel(RTMaterialMonitorClass);
        label_34->setObjectName(QStringLiteral("label_34"));

        verticalLayout_6->addWidget(label_34);

        label_35 = new QLabel(RTMaterialMonitorClass);
        ...
        line = new QFrame(RTMaterialMonitorClass);
        line->setObjectName(QStringLiteral("line"));
        line->setFrameShape(QFrame::VLine);
        line->setFrameShadow(QFrame::Sunken);

        gridLayout_7->addWidget(line, 0, 1, 1, 1);

        groupBox_3 = new QGroupBox(RTMaterialMonitorClass);
        ...
        label_24->setMinimumSize(QSize(100, 100));
        ...
        gridLayout_5->addWidget(lineEdit_15, 2, 1, 1, 1);
        ...
        gridLayout_5->addWidget(lineEdit_16, 3, 1, 1, 1);
        ...
        gridLayout_7->addWidget(groupBox_3, 0, 2, 1, 1);
    ...
    void retranslateUi(QDialog *RTMaterialMonitorClass)
    {
        ...
        groupBox->setTitle(QApplication::translate("RTMaterialMonitorClass", "3.4\345\220\250\347\206\224\347\202\274\347\202\211", Q_NULLPTR));
        ...
        label_31->setText(QApplication::translate("RTMaterialMonitorClass", "TextLabel", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("RTMaterialMonitorClass", "2.5\345\220\250\347\206\224\347\202\274\347\202\211", Q_NULLPTR));
        ...
        label_32->setText(QApplication::translate("RTMaterialMonitorClass", "\350\277\220\350\241\214\344\270\255", Q_NULLPTR));
        label_33->setText(QApplication::translate("RTMaterialMonitorClass", "TextLabel", Q_NULLPTR));
        label_34->setText(QApplication::translate("RTMaterialMonitorClass", "\350\277\220\350\241\214\344\270\255", Q_NULLPTR));
        label_35->setText(QApplication::translate("RTMaterialMonitorClass", "TextLabel", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("RTMaterialMonitorClass", "GroupBox", Q_NULLPTR));
        ...
        label_24->setText(QApplication::translate("RTMaterialMonitorClass", "\347\255\211\345\276\205", Q_NULLPTR));
